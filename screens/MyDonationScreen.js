...
export default class MyDonationScreen extends Component {
     ...
     .then((snapshot)=>{
       snapshot.forEach((doc) => {
         ...
         if(requestStatus === "Item Sent"){
           message = this.state.donorName + "Exchanged a item with you"
         }else{
   ...
   renderItem = ( {item, i} ) =>(
     <ListItem
       ...
       leftElement={<Icon name="shopping-bag" type="font-awesome" color ='#696969'/>}
   ...
   render(){
     return(
       <View style={{flex:1}}>
         <MyHeader navigation={this.props.navigation} title="Exchanged items"/>
         <View style={{flex:1}}>
           {
